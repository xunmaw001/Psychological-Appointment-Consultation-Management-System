 ...
 */
@TableName("bingzheng")
public class BingzhengEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public BingzhengEntity() {

	}

	public BingzhengEntity(T t) {
		try {
    ...
    public String toString() {
        return "Bingzheng{" +
            "id=" + id +
            ", bingzhengName=" + bingzhengName +
            ", bingzhengUuidNumber=" + bingzhengUuidNumber +
            ", bingzhengPhoto=" + bingzhengPhoto +
            ", bingzhengTypes=" + bingzhengTypes +
            ", bingzhengZhengzhuang=" + bingzhengZhengzhuang +
            ", bingzhengContent=" + bingzhengContent +
            ", shangxiaTypes=" + shangxiaTypes +
            ", bingzhengDelete=" + bingzhengDelete +
