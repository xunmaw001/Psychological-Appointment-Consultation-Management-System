                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            WenzhangEntity wenzhangEntity = new WenzhangEntity();
//                            wenzhangEntity.setWenzhangName(data.get(0));                    //心理文章名称 要改的
//                            wenzhangEntity.setWenzhangUuidNumber(data.get(0));                    //心理文章编号 要改的
//                            wenzhangEntity.setWenzhangPhoto("");//详情和图片
//                            wenzhangEntity.setWenzhangTypes(Integer.valueOf(data.get(0)));   //心理文章类型 要改的
//                            wenzhangEntity.setWenzhangClicknum(Integer.valueOf(data.get(0)));   //文章热度 要改的
//                            wenzhangEntity.setZanNumber(Integer.valueOf(data.get(0)));   //赞数量 要改的
//                            wenzhangEntity.setCaiNumber(Integer.valueOf(data.get(0)));   //踩数量 要改的
...
//                            wenzhangEntity.setCreateTime(date);//时间
                        ...
                        if(wenzhangEntities_wenzhangUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [心理文章编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
