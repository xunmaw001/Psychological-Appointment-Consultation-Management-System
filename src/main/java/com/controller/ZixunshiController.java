...
//                            zixunshiEntity.setZixunshiUuidNumber(data.get(0));                    //咨询师编号 要改的
...
//                            zixunshiEntity.setGuahaofei(data.get(0));                    //挂号费用 要改的
//                            zixunshiEntity.setZuoyeContent("");//详情和图片
//                            zixunshiEntity.setCreateTime(date);//时间
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                //咨询师编号
                                if(seachFields.containsKey("zixunshiUuidNumber")){
                                    List<String> zixunshiUuidNumber = seachFields.get("zixunshiUuidNumber");
                                    zixunshiUuidNumber.add(data.get(0));//要改的
                                }else{
                                    List<String> zixunshiUuidNumber = new ArrayList<>();
                                    zixunshiUuidNumber.add(data.get(0));//要改的
                                    seachFields.put("zixunshiUuidNumber",zixunshiUuidNumber);
                                }
                                //咨询师手机号
                        ...
                        if(zixunshiEntities_username.size() >0 ){
                         ...
                         //咨询师编号
                        List<ZixunshiEntity> zixunshiEntities_zixunshiUuidNumber = zixunshiService.selectList(new EntityWrapper<ZixunshiEntity>().in("zixunshi_uuid_number", seachFields.get("zixunshiUuidNumber")));
                        if(zixunshiEntities_zixunshiUuidNumber.size() >0 ){
                            ArrayList<String> repeatFields = new ArrayList<>();
                            for(ZixunshiEntity s:zixunshiEntities_zixunshiUuidNumber){
                                repeatFields.add(s.getZixunshiUuidNumber());
                            }
                            return R.error(511,"数据库的该表中的 [咨询师编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //咨询师手机号
