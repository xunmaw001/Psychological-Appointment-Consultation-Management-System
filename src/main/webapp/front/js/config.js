...
var centerMenu = [
    ...
    ,{
        name: '常见病症收藏',
        url: '../bingzhengCollection/list.html'
    }
    ,{
        name: '心理文章收藏',
...
var adminurl =  "http://localhost:8080/xinliyuyuezixunguanlixitong/admin/dist/index.html#/login";
