    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="心理文章名称" prop="wenzhangName">
                       <el-input v-model="ruleForm.wenzhangName"
                                 placeholder="心理文章名称" clearable  :readonly="ro.wenzhangName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="心理文章名称" prop="wenzhangName">
                           <el-input v-model="ruleForm.wenzhangName"
                                     placeholder="心理文章名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="心理文章编号" prop="wenzhangUuidNumber">
                       <el-input v-model="ruleForm.wenzhangUuidNumber"
                                 placeholder="心理文章编号" clearable  :readonly="ro.wenzhangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="心理文章编号" prop="wenzhangUuidNumber">
                           <el-input v-model="ruleForm.wenzhangUuidNumber"
                                     placeholder="心理文章编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.wenzhangPhoto" label="心理文章照片" prop="wenzhangPhoto">
                        <file-upload
                            tip="点击上传心理文章照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.wenzhangPhoto" label="心理文章照片" prop="wenzhangPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="心理文章类型" prop="wenzhangTypes">
                        <el-select v-model="ruleForm.wenzhangTypes" :disabled="ro.wenzhangTypes" placeholder="请选择心理文章类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="心理文章类型" prop="wenzhangValue">
                        <el-input v-model="ruleForm.wenzhangValue"
                            placeholder="心理文章类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wenzhangContent"  label="心理文章内容" prop="wenzhangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wenzhangContent" label="心理文章内容" prop="wenzhangContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   wenzhangName: [
                              { required: true, message: '心理文章名称不能为空', trigger: 'blur' },
                          ],
                   wenzhangUuidNumber: [
                              { required: true, message: '心理文章编号不能为空', trigger: 'blur' },
                          ],
                   wenzhangPhoto: [
                              { required: true, message: '心理文章照片不能为空', trigger: 'blur' },
                          ],
                   wenzhangTypes: [
                              { required: true, message: '心理文章类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   wenzhangClicknum: [
                              { required: true, message: '文章热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   wenzhangContent: [
                              { required: true, message: '心理文章内容不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
