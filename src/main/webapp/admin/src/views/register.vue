<template>
    <div style="backgroundImage: url('/xinliyuyuezixunguanlixitong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">心理预约咨询管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="咨询师姓名" class="input" v-if="tableName=='zixunshi'">
                            <el-input v-model="ruleForm.zixunshiName" autocomplete="off" placeholder="咨询师姓名"  />
                        </el-form-item>
                        <el-form-item label="咨询师手机号" class="input" v-if="tableName=='zixunshi'">
                            <el-input v-model="ruleForm.zixunshiPhone" autocomplete="off" placeholder="咨询师手机号"  />
                        </el-form-item>
                        <el-form-item label="咨询师身份证号" class="input" v-if="tableName=='zixunshi'">
                            <el-input v-model="ruleForm.zixunshiIdNumber" autocomplete="off" placeholder="咨询师身份证号"  />
                        </el-form-item>
